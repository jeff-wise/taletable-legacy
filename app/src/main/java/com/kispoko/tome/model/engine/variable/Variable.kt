                        ...
                        : Variable(variableId, label, description, tags)
{
    ...
    companion object : Factory<BooleanVariable>
    {
        ...
        {
            is DocDict -> effApply6(::BooleanVariable,
                                    // Model Id
                                    valueResult(UUID.randomUUID()),
                                    // Variable Id
                                    doc.at("name") ap {
                                        val variableId =
                                            effApply3(::VariableId,
                                                      valueResult(UUID.randomUUID()),
                            ...
                            : Variable(variableId, label, description, tags)
{
    ...
    companion object : Factory<DiceRollVariable>
    {
        ...
        {
            is DocDict -> effApply6(::DiceRollVariable,
                                    // Model Id
                                    valueResult(UUID.randomUUID()),
                                    // Variable Id
                                    doc.at("name") ap {
                          ...
                          : Variable(variableId, label, description, tags)
{
    ...
    companion object : Factory<NumberVariable>
    {
        ...
        {
            is DocDict -> effApply6(::NumberVariable,
                                    // Model Id
                                    valueResult(UUID.randomUUID()),
                                    // Variable Id
                                    doc.at("name") ap {
                        ...
                        : Variable(variableId, label, description, tags)
{
    ...
    companion object : Factory<TextVariable>
    {
        ...
        {
            is DocDict -> effApply7(::TextVariable,
                                    // Model Id
                                    valueResult(UUID.randomUUID()),
                                    // Variable Id
                                    doc.at("name") ap {
                                 ...
                                 val name : Func<VariableName>) : VariableReference()
{
    ...
    companion object : Factory<VariableReference>
    {
        override fun fromDocument(doc: SpecDoc) : ValueParser<VariableReference> = when (doc)
        {
            is DocDict -> effApply2(::VariableReferenceName,
                                    // Model Id
                                    valueResult(UUID.randomUUID()),
                                    // Variable Name
                                    doc.at("name") ap {
                                ...
                                val tag : Func<VariableTag>) : VariableReference()
{
    ...
    companion object : Factory<VariableReference>
    {
        override fun fromDocument(doc: SpecDoc) : ValueParser<VariableReference> = when (doc)
        {
            is DocDict -> effApply2(::VariableReferenceTag,
                                    // Model Id
                                    valueResult(UUID.randomUUID()),
                                    // Variable Name
                                    doc.at("tag") ap {
