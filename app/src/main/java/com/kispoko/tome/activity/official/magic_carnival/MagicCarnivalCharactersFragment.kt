...
/**
 * Magic Carnival Official Characters
 */
class MagicCarnivalCharactersFragment : Fragment()
{
    ...
    companion object
    {
        fun newInstance(theme : Theme) : MagicCarnivalCharactersFragment
        {
            val fragment = MagicCarnivalCharactersFragment()
