...
import com.kispoko.tome.activity.official.pathfinder_one_srd.PathfinderOneSRDCharactersFragment
...
/**
 * Open Magic Carnival Session
 */
class OpenMagicCarnivalSessionActivity : AppCompatActivity()
{
    ...
    override fun onCreate(savedInstanceState : Bundle?)
    {
        ...
        // > Toolbar
        this.configureToolbar("The Magic Carnival")
            ...
            : FragmentStatePagerAdapter(fragmentManager)
{
    ...
    override fun getItem(position : Int) : Fragment =
        when (position)
        {
            0    -> MagicCarnivalCharactersFragment.newInstance(theme)
            1    -> MagicCarnivalCreaturesFragment.newInstance(theme)
            2    -> MagicCarnivalCharactersFragment.newInstance(theme)
            3    -> MagicCarnivalCharactersFragment.newInstance(theme)
            4    -> MagicCarnivalCharactersFragment.newInstance(theme)
            else -> MagicCarnivalCharactersFragment.newInstance(theme)
        }
