...
package com.kispoko.tome.activity.official.fifth_ed_srd
...
/**
 * Open 5th Edition SRD Session
 */
//class OpenFifthEdSRDSessionActivity : AppCompatActivity()
//{
//
//    // -----------------------------------------------------------------------------------------
//    // PROPERTIES
...
//    {
//        val fab = this.findViewById<FloatingActionButton>(R.id.button)
//        //fab.hide()
//        this.fab = fab
//    }
//
...
//    {
//        val bottomSheet = this.findViewById<LinearLayout>(R.id.bottom_sheet)
//
...
//        when (position)
//        {
//            0    -> FifthEdSRDCharactersFragment.newInstance(theme)
//            1    -> FifthEdSRDCharactersFragment.newInstance(theme)
//            2    -> FifthEdSRDCharactersFragment.newInstance(theme)
//            3    -> FifthEdSRDCharactersFragment.newInstance(theme)
//            4    -> FifthEdSRDCharactersFragment.newInstance(theme)
//            else -> FifthEdSRDCharactersFragment.newInstance(theme)
//        }
//
//
