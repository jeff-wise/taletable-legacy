...
public class GroupListItemView
{
    ...
    private static RelativeLayout viewLayout(Context context)
    {
        ...
        layout.id                       = R.id.group_list_item_layout;
        layout.orientation              = LinearLayout.HORIZONTAL;
        layout.width                    = LinearLayout.LayoutParams.MATCH_PARENT;
        layout.height                   = LinearLayout.LayoutParams.WRAP_CONTENT;

        layout.margin.left              = R.dimen.group_list_item_margin_horz;
        layout.margin.right             = R.dimen.group_list_item_margin_horz;
        layout.margin.top               = R.dimen.group_list_item_margin_vert;
        layout.margin.bottom            = R.dimen.group_list_item_margin_vert;
    ...
    private static ImageView dragIcon(Context context)
    {
        ...
        icon.margin.right           = R.dimen.group_list_item_drag_margin_right;
    ...
    private static TextView nameView(Context context)
    {
        ...
        name.id                 = R.id.group_list_item_name;
        ...
        name.size               = R.dimen.group_list_item_name_text_size;
    ...
    private static LinearLayout groupsView(Context context)
    {
        ...
        count.id                        = R.id.group_list_item_row_count;
        ...
        count.size                      = R.dimen.group_list_item_group_count_text_size;
        count.color                     = R.color.dark_blue_hl_8;

        count.margin.right              = R.dimen.group_list_item_group_count_margin_right;

        // [3 B] Label
        // -------------------------------------------------------------------------------------

        label.id                        = R.id.group_list_item_row_count_label;
        label.width                     = LinearLayout.LayoutParams.WRAP_CONTENT;
        label.height                    = LinearLayout.LayoutParams.WRAP_CONTENT;

        label.font                      = Font.sansSerifFontBold(context);
        label.size                      = R.dimen.group_list_item_group_label_text_size;
