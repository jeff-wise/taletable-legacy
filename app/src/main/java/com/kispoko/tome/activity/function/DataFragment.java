...
public class DataFragment extends Fragment
{
    ...
    private View view()
    {
        ...
        // > Name Field
        LinearLayout nameField = Form.field(R.string.function_field_name_label,
                                            R.string.function_field_name_description,
                                            Form.textInput(this.function.name(), getContext()),
                                            getContext());

        // > Label Field
        LinearLayout labelField = Form.field(R.string.function_field_label_label,
                                             R.string.function_field_label_description,
                                             Form.textInput(this.function.label(), getContext()),
                                             getContext());
        ...
        LinearLayout descriptionField =
                Form.field(R.string.function_field_description_label,
                           ...
                           Form.textInput(this.function.description(), getContext()),
                           getContext());
