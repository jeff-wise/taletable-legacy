...
/**
 * Starfinder SRD Official Characters
 */
class StarfinderSRDCharactersFragment : Fragment()
{
    ...
    companion object
    {
        fun newInstance(theme : Theme) : StarfinderSRDCharactersFragment
        {
            val fragment = StarfinderSRDCharactersFragment()
