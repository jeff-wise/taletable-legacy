...
class ValueSetsActivity : AppCompatActivity()
{
                                           ...
                                           valueSets : List<ValueSet>)
    {
        ...
        recyclerView.adapter =
                ValueSetRecyclerViewAdapter(valueSets, gameId, this.appSettings.themeId())
...
class ValueSetSummaryViewHolder(itemView : View) : RecyclerView.ViewHolder(itemView)
{
    ...
    init
    {
        this.headerView = itemView.findViewById(R.id.value_set_item_header) as TextView
        this.descView   = itemView.findViewById(R.id.value_set_item_description) as TextView
        this.countView  = itemView.findViewById(R.id.value_set_item_count) as TextView
    }
...
object ValueSetSummaryView
{
    ...
    private fun viewLayout(context : Context) : LinearLayout
    {
        ...
        layout.id                   = R.id.value_set_item_layout
    ...
    private fun summaryView(themeId : ThemeId, context : Context) : LinearLayout
    {
        ...
        header.id                   = R.id.value_set_item_header
...
//        header.margin.bottomDp      = 3f
        ...
        description.id              = R.id.value_set_item_description
    ...
    private fun itemCountView(themeId : ThemeId, context : Context) : TextView
    {
        ...
        count.id                    = R.id.value_set_item_count
