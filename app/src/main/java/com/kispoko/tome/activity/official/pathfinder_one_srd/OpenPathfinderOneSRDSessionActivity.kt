...
/**
 * Open Pathfinder 1 SRD Sessions
 */
//class OpenPathfinderOneSRDSessionActivity : AppCompatActivity()
//{
//
//    // -----------------------------------------------------------------------------------------
//    // PROPERTIES
...
//
//        // > Toolbar
//        this.configureToolbar("Pathfinder 1 SRD")
//
//        // > Theme
...
//        when (position)
//        {
//            0    -> PathfinderOneSRDCharactersFragment.newInstance(theme)
//            1    -> PathfinderOneSRDCharactersFragment.newInstance(theme)
//            2    -> PathfinderOneSRDCharactersFragment.newInstance(theme)
//            3    -> PathfinderOneSRDCharactersFragment.newInstance(theme)
//            4    -> PathfinderOneSRDCharactersFragment.newInstance(theme)
//            else -> PathfinderOneSRDCharactersFragment.newInstance(theme)
//        }
//
//
