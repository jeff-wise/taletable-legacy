...
import com.kispoko.tome.activity.official.heroes.CharactersRecyclerViewAdapter
import com.kispoko.tome.activity.official.heroes.MagicOfHeroesCharactersFragment
 ...
 */
class FifthEdSRDCharactersFragment : Fragment()
{
    ...
    companion object
    {
        fun newInstance(theme : Theme) : FifthEdSRDCharactersFragment
        {
            val fragment = FifthEdSRDCharactersFragment()
