...
public class SheetDatabaseManager extends SQLiteOpenHelper
{
    ...
    public void onCreate(SQLiteDatabase db)
    {
        ...
        final String CREATE_GROUP_LAYOUT_TABLE =
            ...
            "FOREIGN KEY (" + SheetContract.GroupLayout.COLUMN_GROUP_ID_NAME + ") REFERENCES " +
        ...
        final String CREATE_GROUP_LAYOUT_ROW_TABLE =
            ...
            "FOREIGN KEY (" + SheetContract.GroupLayoutRow.COLUMN_GROUP_LAYOUT_ID_NAME + ") REFERENCES " +
                SheetContract.GroupLayout.TABLE_NAME + "(" + SheetContract.GroupLayout.COLUMN_GROUP_LAYOUT_ID_NAME + ") )";
        ...
        final String CREATE_GROUP_LAYOUT_FRAME_TABLE =
            ...
            "FOREIGN KEY (" + SheetContract.GroupLayoutFrame.COLUMN_COMPONENT_ID_NAME + ") REFERENCES " +
        ...
        final String CREATE_COMPONENT_TABLE_ROW_TABLE =
            "CREATE_TABLE IF NOT EXISTS " + SheetContract.ComponentTableRow.TABLE_NAME + " (" +
            ...
            SheetContract.ComponentTableRow.COLUMN_INDEX_NAME + " " + SheetContract.ComponentTableRow.COLUMN_INDEX_TYPE + ", " +
            ...
            "FOREIGN KEY (" + SheetContract.ComponentTableRow.COLUMN_TABLE_ID_NAME + ") REFERENCES " +
                SheetContract.ComponentTable.TABLE_NAME + "(" + SheetContract.ComponentTable.COLUMN_TABLE_ID_NAME + ") )";
