...
package com.kispoko.tome.rules.programming.summation;
...
import com.kispoko.tome.rules.programming.summation.term.Term;
...
public class Summation implements Model
{
            ...
            throws SummationException
    {
        ...
        {
            sum += term.value();
            Log.d("***SUMMATION", "sum is " + Integer.toString(sum));
        }
