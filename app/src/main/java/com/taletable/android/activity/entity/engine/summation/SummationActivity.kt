...
import com.taletable.android.router.MessageUpdateSummationNumberTerm
...
class SummationActivity : AppCompatActivity()
{
    ...
    override fun onCreate(savedInstanceState : Bundle?)
    {
        ...
        {
            val entitySummationEff = com.taletable.android.rts.entity.summation(summationId, entityId)
