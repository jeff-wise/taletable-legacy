...
import com.taletable.android.lib.orm.sql.query.UpdateQuery
import com.taletable.android.lib.orm.sql.query.UpsertQuery
import maybe.Just
...
object DatabaseManager
{
    ...
    {
        val db = SQLiteDatabase.openOrCreateDatabase("/data/data/com.taletable.tome/main.db", null)
        this.database = db
